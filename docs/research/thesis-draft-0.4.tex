...
\section{技術的背景3：LLMによるリアルタイムUI生成の登場}
...
\section{既存研究：LLM-Hardened DSLによる解決}
...
\subsection{Jellyからの継承：データモデルベースのアプローチ}
